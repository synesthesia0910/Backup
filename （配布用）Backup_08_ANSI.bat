...
robocopy \\192.168.0.117\share F:\Backup\robocopy_Sabun\%DATE:/=_% /S /FFT /XA:SH /XD "trashbox" /maxage:%DATE:/=% /R:1 /W:1 /LOG+:"C:\PC_Maintenance\robocopy\log\PC\Sabun\Desktop_%DATE:/=_%.log"
